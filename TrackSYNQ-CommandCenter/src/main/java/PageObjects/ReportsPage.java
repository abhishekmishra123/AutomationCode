...
public class ReportsPage extends ActionMethods {
	...
	private String startDate = "xpath://div[@class='ant-form-item-control-wrapper']//input[@placeholder='Select date']";
	...
	String	startDateText= driver.findElement(By.xpath("//div[@class='ant-form-item-control-wrapper']//input[@placeholder='Select date']")).getAttribute("placeholder");
	...
	public String getEndDatePlaceholder() {
		String	endDateText= driver.findElement(By.xpath("//div[@class='ant-calendar-date-input-wrap']//input[@placeholder='Select date']")).getAttribute("placeholder");
		return endDateText;
	}
	...
	public void checkPagination() {
		...
		//System.out.println("Total number displayed Count================" + displayedCount);
